                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{route('subcategories.store')}}" class="needs-validation" novalidate method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select id="active" name="categories" class="form-select @error('active')border-danger  @enderror">
                                                ...
                                                <option value="{{$categories_data->id}}">{{$categories_data->title}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="mb-3">
