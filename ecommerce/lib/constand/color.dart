...
class TColor {
  ...
  static Color get KPrimarykeycolor => const Color(0XFF6A62B7);
  static Color get KBackgroundcolor => const Color(0XFFE5E5E5);
  static Color get navigationbar => const Color(0XFF222831);
}